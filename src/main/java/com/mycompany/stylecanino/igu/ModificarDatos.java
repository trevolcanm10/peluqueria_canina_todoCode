...
import com.mycompany.stylecanino.igu.VerDatos;
...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private VerDatos verDatos = new  VerDatos(); 
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
      ...
      //mensaje que el proceso fue un ´éxito
     verDatos.mostrarMensaje("Edición realizada correctamente","Info","Edición correcta");
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtNombre.setText(masco.getNombre());//Seteamos el texto, es decir, se limpia el texto ingresado por el usuario
