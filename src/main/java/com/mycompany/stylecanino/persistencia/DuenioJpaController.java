...
package com.mycompany.stylecanino.persistencia;

import com.mycompany.stylecanino.logica.Duenio;
import com.mycompany.stylecanino.persistencia.exceptions.NonexistentEntityException;
...
public class DuenioJpaController implements Serializable {
    ...
    public DuenioJpaController() {
       emf = Persistence.createEntityManagerFactory("styleCaninoPU");
    }
